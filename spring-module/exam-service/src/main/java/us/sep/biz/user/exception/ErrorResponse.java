...
public class ErrorResponse {
    ...
    public ErrorResponse(CustomizeException ex, String path, Map<String, Object> errorDetail) {
        this(500, HttpStatus.BAD_REQUEST.value(), ex.getMessage(), path, errorDetail);
    }
